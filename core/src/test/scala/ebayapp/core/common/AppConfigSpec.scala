...
class AppConfigSpec extends CatsSpec {
  "An AppConfig" should {
    ...
    "load itself from application.conf file" in {
      ...
      conf.retailer.selfridges.headers mustBe Map("X-Reroute-To" -> "https://www.selfridges.com", "User-Agent" -> "PostmanRuntime/7.28.3", "referer" -> "https://www.selfridges.com", "api-key" -> "key")
