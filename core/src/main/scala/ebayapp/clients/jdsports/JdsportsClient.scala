...
final private class LiveJdsportsClient[F[_]](
  ...
  private val defaultHeaders: Map[String, String] = Map(
    ...
    "User-Agent"      -> "Mozilla/5.0 (Macintosh; Intel Mac OS X x.y; rv:42.0) Gecko/20100101 Firefox/42.0/605.1.15 (KHTML, like Gecko) Version/13.1.1 Mobile/15E148 Safari/604.1",
