  ...
  def videoGames[F[_]: Sync: Logger: Timer](
    ...
    Sync[F].delay {
      new EbayDealsFinder[F, ItemDetails.Game] {
        ...
        override implicit def mapper: EbayItemMapper[ItemDetails.Game] = EbayItemMapper.gameDetailsMapper
        override implicit def params: EbaySearchParams[ItemDetails.Game] = EbaySearchParams.videoGameSearchParams
      }
    }
}
