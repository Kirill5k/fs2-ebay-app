  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "sniper thumbs", "(game|skin|thumb|Silicone|floating) grip", "thumb( )?(stick|pack)", "(screen|grip) (protector|combat|stick)", "(sports|leg) strap", "Cleaning Cloth",
        ...
        "diablo.*(rune|item|gold|softcore|(nm|nightmare) dungeon|modded|\\bGEM(s)?\\b|weapon|\\bXP\\b|\\bPC\\b)",
