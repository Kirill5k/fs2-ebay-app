  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "fortnite", "overwatch\\s+(sony|ps|xbox|legendary|origins|game)", "earphone", "Crossbody", "DRESSING GOWN", "drinks cooler",
        "Miss Melody", "Thrustmaster", "Xiaomi", "OTL Technologies", "logitech", "mechanical keyboard", "Gioteck", "\\bd( )?link\\b",
