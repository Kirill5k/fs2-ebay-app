  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "\\b200[0-9]\\b", "(demo|game|global)( )?(code|disc|key|cart|pass)",
        ...
        "coin", "skins", "(collectors|empty|steel|slim|display)( )?((game )?box|case)", "soundtrack", "poster", "protection accessor", "PLAYSTAND",
        ...
        "horipad", "(mouse|keyboard|cord|power|\\bAC\\b|hdmi|cockpit)( )?(adapt(e|o)r|level|supply)", "tv tuner", "home circuit", "Origami Sheets", "\\bPlaygro\\b",
        ...
        "fortnite", "character skin", "overwatch\\s+(sony|ps|xbox|legendary|origins|game)", "earphone", "Crossbody", "DRESSING GOWN",
        "Miss Melody", "pencil case", "Thrustmaster", "Xiaomi", "OTL Technologies",
        ...
        "nexigo", "fan cooling", "Eve Valkyrie", "invaders plush", "xbox (original|classic)", "Original Xbox", "figpin", "Smallstuff", "LEXIBOOK",
        "battery lid", "media remote", "game \\d+ for", "NTSCjp", "ZX SPECTRUM", "all platforms", "AutoPop Trophies", "Candlestick",
        ...
        "(cod|of duty|mw\\d|warzone)(?s).*(burger|dmz|jack link|service|crossbow|code|items|camo|points|boost|hyper|unlock|mountain dew|warzone|skin|level|card|\\bXP\\b)",
