...
private[ebay] object search {
  ...
  trait EbaySearchParams {
    ...
    def queryParams(from: Instant, query: String, seller: Option[String]): Map[String, String] = {
  ...
  object EbaySearchParams {
    ...
    private val conditionIdsFilter    = "conditionIds:{1000|1500|2000|2500|2750|3000|4000|5000|6000}"
    private val priceFilter           = (from: Int, to: Int) => s"price:[$from..$to]"
    ...
    private object SmartLightingSearchParams extends EbaySearchParams {
      override val searchFilterTemplate: String       = s"$searchFiltersBase,$conditionIdsFilter,${priceFilter(0, 400)}"
      override val categoryId: Int                    = 11700
      override val filter: EbayItemSummary => Boolean = item => item.buyingOptions.intersect(accepterBuyingOptions).nonEmpty
    }
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "\\bhdmi\\b", "\\bUSB(C)?\\b", "\\bhdd\\b", "blox fruit", "gift box", "sprite", "your choic",
        ...
        "(case|variety|accessor(ies|y).*{0,5}|storage|charge|robot|dice|charging|streaming) (pack|system|set|kit|box)", "no dis(c|k)", "Season( \\d)? Pass", "pass set", "keychain",
        ...
        "Option File", "offline", "online", "unlock all", "mini dock", "Press Release", "Pre( )?Release", "card reader", "Bigben Interactive",
        ...
        "Cheats Bible", "500gb console", "tiktok", "modded outfit", "riding gloves", "electric scooter", "figurine", "arcade machine", "hoodie", "slipper socks",
        ...
        "Modiphius", "Lapse disc", "Turtle Beach", "BabyTrold", "LED neon", "Privacy Curtain",
        ...
        "borderlands.*(build|grind|loot|gold|players|artifact|crit|recoil|level|lvl|takedown|damage|Teething|dmg|mayhem|lvl|cash|x50|legendary|money|mod)",
