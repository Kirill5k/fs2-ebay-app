  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "(m|b)illion (pure)? cash", "\\d+M (cash|money)",
        ...
        "official (server|magazin)", "Option File", "offline", "online", "unlock all", "mini dock", "Press Release",
        ...
        "(no|protective|foreign|case|slip|silicone|phone|style|\\bUS\\b|miss(ing)?) cover(s)?", "promotional game", "Microphone", "KontrolFreek",
        ...
        "figure(s)? bundle", "k eso", "(mini|plush|gift|grip(s)?) (set|toy)", "pad pro", "thumb( )?(stick|pack)", "cable (guy|adapter|pack)", "Philips",
        ...
        "membership", "12 month", "(wallpaper|dynamic|ps\\d) theme", "themes", "account", "(MODDED|FN) ACC", "RDS Industries", "verbatim",
        ...
        "(cod|of duty|mw\\d|warzone)(?s).*(plan|tool|zombi|legendary|tools|monster|energy|blueprint|schematic|burger|dmz|jack link|service|crossbow|code|items|camo|points|boost|hyper|unlock|mountain dew|warzone|skin|level|card|\\bXP\\b)",
