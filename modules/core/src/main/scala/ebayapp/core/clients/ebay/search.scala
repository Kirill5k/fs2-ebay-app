  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "only cart", "STAND HUB", "nacon", "stereo hset", "Subsonic PRO",
        ...
        "(read|see) (detail|desc|post)", "please(?s).*read", "read(?s).*please", "(docking|charging|power|desk|console|media)( )?(charging|dock|station|stand)", "download",
