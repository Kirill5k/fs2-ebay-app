  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "case for (switch|nintendo)", "Fightpad",
        ...
        "figure(s)? bundle", "k eso", "(mini|plush|gift|grip(s)?( n play)?) (kit|set|toy)", "pad pro", "thumb( )?(tread|stick|pack)", "cable (guy|adapter|pack)", "Philips",
        ...
        "Strikepack Horizon", "twitch", "Best Buy Exclusive",
