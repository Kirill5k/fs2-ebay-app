  ...
  object EbaySearchParams {
    ...
    private object VideoGameSearchParams extends EbaySearchParams {
      ...
      private val LISTING_NAME_TRIGGER_WORDS = List(
        ...
        "Cheats Bible", "500gb console", "tiktok", "modded outfit", "riding gloves", "electric scooter",
        ...
        "(cod|of duty|mw\\d|warzone)(?s).*(legendary|tools|monster|energy|blueprint|schematic|burger|dmz|jack link|service|crossbow|code|items|camo|points|boost|hyper|unlock|mountain dew|warzone|skin|level|card|\\bXP\\b)",
